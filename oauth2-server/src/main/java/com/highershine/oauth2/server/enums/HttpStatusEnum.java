package com.highershine.oauth2.server.enums;
...
public enum HttpStatusEnum {
    ...
    public static String getMsgByCode(int value) {
        HttpStatusEnum[] httpStatusEnum = values();
        for (HttpStatusEnum typeEnum : httpStatusEnum) {
    ...
    HttpStatusEnum(Integer code, String msgUS, String msg) {
        this.code = code;
        this.msgUS = msgUS;
        this.msg = msg;
    }
